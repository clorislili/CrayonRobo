...
# load shape
new_dir = '/vepfs-cnsh4137610c2f4c/algo/user8/lixiaoqi/xcy/where2act/data/where2act_original_sapien_dataset'
object_urdf_fn = new_dir + '/%s/mobility_vhacd.urdf' % shape_id
