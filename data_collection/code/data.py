...
class SAPIENVisionDataset(data.Dataset):
    ...
    def __init__(self, primact_types, category_types, data_features, buffer_max_num, \
            abs_thres=0.01, rel_thres=0.5, dp_thres=0.5, img_size=336, \
    ...
    def check_success(self, result_data, primact_type):
        ...
        success = (abs_motion > self.abs_thres) and (abs_motion / tot_motion > self.rel_thres) # modified to be 'and' according to Cloris
        if not success:
            return False
